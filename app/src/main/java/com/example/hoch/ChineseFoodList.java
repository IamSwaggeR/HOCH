...
public class ChineseFoodList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chinese_food_list);

        toolbar = findViewById(R.id.toolbarChineseFood);
        ...
        ImageButton imageButton3 = findViewById(R.id.imageButtonCHShopping);
        ...
        tabLayout = findViewById(R.id.tablayout_chinese_food_container);
        viewPager =  findViewById(R.id.view_pager_chinese_food_container);
