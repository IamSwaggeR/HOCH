...
public class EuropeFoodList extends AppCompatActivity {
    Toolbar toolbar;
    TabLayout tabLayout;
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_europe_food_list);

        toolbar = findViewById(R.id.toolbarEuropeFood);
        ...
        ImageButton imageButton3 = findViewById(R.id.imageButtonEUShopping);
        ...
        tabLayout = findViewById(R.id.tablayout_europe_food_container);
        viewPager =  findViewById(R.id.view_pager_europe_food_container);
